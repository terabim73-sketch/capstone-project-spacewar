...
class Game:
    ...
    def start_text(self):
        ...
        text2 = font2.render('MINI GAME AKHY 2026', True, 'white') 
    ...
    def create_timer(self, remaining_time):
        font = pygame.font.SysFont('Calibri', 30)
        text = font.render(f"Time: {remaining_time}s", True, 'yellow')
        text_rect = text.get_rect(center=(s_width/2, 15)) 
        screen.blit(text, text_rect)
    ...
    def create_lives(self):
        self.live_img = pygame.image.load(heart_image)
        self.live_img = pygame.transform.scale(self.live_img, (30, 30))
        n = 0
        for i in range(self.lives):
            screen.blit(self.live_img, (10+n, 0)) 
            n += 40
    ...
    def create_score(self):
        ...
        text_rect = text.get_rect(center=(s_width-150, 15)) 
        screen.blit(text, text_rect)
    ...
    def run_game(self):
        ...
        while True:
            ...
            remaining_time = max(0, self.win_time_limit - elapsed_seconds)
            ...
            self.create_lives()
            self.create_score()
            self.create_timer(remaining_time)
